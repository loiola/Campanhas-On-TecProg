...
public class LoadCampaignParse extends BasicParseServlet {
	...
	/*
	 * Servlet asked by the View to extract a Data File of Campaigns and Send to
	 * Campaign Parse Control Classes to populate the information extracted in
	 * the database
	 */
	 ...
	 * Campaign File Type to be used by readDataFile method (super) to populate
