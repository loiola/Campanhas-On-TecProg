...
import static test.model.bean.BeanTeste.instanciarCampanha;
import static test.model.bean.BeanTeste.instanciarDespesa;
import static test.model.bean.BeanTeste.instanciarDoador;
import static test.model.bean.BeanTeste.instanciarFornecedor;
import static test.model.bean.BeanTeste.instanciarMovimentacaoFinanceira;
import static test.model.bean.BeanTeste.instanciarReceita;
...
public class MovimentacaoFinanceiraTeste {
	...
	public void equalsDeveRetornarFalsoSeForemMovimentacoesFinancierasDiferentes() {
		...
		movimentacaoFinanceira2.setFinancialTransactionCampaign(campaign);
		Assert.assertFalse(financialTransaction.equals(movimentacaoFinanceira2));
		campaign.setCampaignNameOfUrn(BeanTeste.STRING_TESTE);
		movimentacaoFinanceira2.setFinancialTransactionCampaign(campaign);
		movimentacaoFinanceira2.setFinancialTransactionDescription(BeanTeste.STRING_TESTE_2);
		Assert.assertFalse(financialTransaction.equals(movimentacaoFinanceira2));
		movimentacaoFinanceira2.setFinancialTransactionDescription(BeanTeste.STRING_TESTE);
		movimentacaoFinanceira2.setFinancialTransactionPaymentType(BeanTeste.STRING_TESTE_2);
		Assert.assertFalse(financialTransaction.equals(movimentacaoFinanceira2));
		movimentacaoFinanceira2.setFinancialTransactionPaymentType(BeanTeste.STRING_TESTE);
		movimentacaoFinanceira2.setFinancialTransactionDocumentNumber(BeanTeste.STRING_TESTE_2);
		Assert.assertFalse(financialTransaction.equals(movimentacaoFinanceira2));
		movimentacaoFinanceira2.setFinancialTransactionDocumentNumber(BeanTeste.STRING_TESTE);
		movimentacaoFinanceira2.setFinancialTransactionType(BeanTeste.STRING_TESTE_2);
		Assert.assertFalse(financialTransaction.equals(movimentacaoFinanceira2));
		movimentacaoFinanceira2.setFinancialTransactionType(BeanTeste.STRING_TESTE);
		movimentacaoFinanceira2.setFinancialTransactionPrice(BeanTeste.FLOAT_TESTE_2);
		Assert.assertFalse(financialTransaction.equals(movimentacaoFinanceira2));
		
		Assert.assertEquals(BeanTeste.INT_TESTE, financialTransaction.getFinancialTransactionIdentifier());
		Assert.assertEquals(BeanTeste.STRING_TESTE, financialTransaction.getFinancialTransactionDate());
