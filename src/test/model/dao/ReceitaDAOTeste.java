...
public class ReceitaDAOTeste extends TemplateTest {
	...
	public void deveRecuperarUmaListaDeReceitas() throws SQLException {
		...
		this.cargo1.setPositionDescription("POSITION UM");
		...
		receita1.setRevenueElectoralReceipt("RECEIPT ELEITORAL UM");
		...
		this.cargo2.setPositionDescription("POSITION DOIS");
		...
		receita2.setRevenueElectoralReceipt("RECEIPT ELEITORAL DOIS");
